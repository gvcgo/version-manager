$env:GOOS="darwin"
$env:GOARCH="arm64"
Remove-Item ../build/vmr_darwin-arm64.zip
...
$env:GOOS="darwin"
$env:GOARCH="amd64"
Remove-Item ../build/vmr_darwin-amd64.zip
...
$env:GOOS="linux"
$env:GOARCH="arm64"
Remove-Item ../build/vmr_linux-arm64.zip
...
$env:GOOS="linux"
$env:GOARCH="amd64"
Remove-Item ../build/vmr_linux-amd64.zip
...
$env:GOOS="windows"
$env:GOARCH="arm64"
Remove-Item ../build/vmr_windows-arm64.zip
...
$env:GOOS="windows"
$env:GOARCH="amd64"
Remove-Item ../build/vmr_windows-amd64.zip
